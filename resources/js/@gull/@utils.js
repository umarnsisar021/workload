...
export  function  can(permissions,role){
  return permissions.includes(role);
}



export function dbToDisplayDateFormat(date){
...
export function displayToDBDateFormat(date){
  var dateString='';
  if(date){
    var date= new Date(date);
    date = date.getFullYear()+'-'+(date.getMonth()+1)+'-'+date.getDate();
    var dateString = moment( new Date(date)).format('YYYY-MM-DD');
  }
  return dateString;
}