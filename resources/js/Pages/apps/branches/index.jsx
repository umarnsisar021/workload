        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    Inertia.post(route('branches.destroy', id), formData);
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    Inertia.post(route('branches.restore', id), formData);
                    customTableRef.current.fetchData(1);
                }
            });
    }
            ...
            cell: row =><div className="btn-group">
                            <Dropdown>
                                ...
                                {(row.deleted_at == null) &&
                                    <DropdownMenu>
                                        {editFound &&
                                            <InertiaLink href={route('branches.edit',row.id)} className="dropdown-item cursor-pointer" as="button">
                                    ...
                                    <div className="col-md-4 text-right">
                                        <div className="btn-group dropleft">
                                            <Dropdown>
                                                ...
                                                <DropdownMenu>
                                                    <InertiaLink className="dropdown-item cursor-pointer" href={route('branches.create')}>
                                                        Add
                                                    </InertiaLink>
                                                </DropdownMenu>
                                            </Dropdown>
