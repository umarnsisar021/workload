...
export default function trash(props) {
    ...
    const fetchUsers = async (page, size = perPage) => {
        ...
        const response = await axios.get(
            base_url + `/locations/location_trash?page=${page}&per_page=${size}&delay=1`
        );
                    ...
                    <div className="card text-left">
                        ...
                        <div className="card-body">
                            <div className="table-responsive">
                                ...
                                <div>
                                    <InertiaLink href={route('locations.trashList')} className="pr-2">
                                        View Trash Records
                                    </InertiaLink>
                                    |
                                    <InertiaLink href={route('locations.index')} className="pl-2">
                                        View Active Records
                                    </InertiaLink>
                                </div>
