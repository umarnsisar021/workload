...
const SmsAutoResponder = (props) => {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    Inertia.post(route('sms_responders.destroy', id), formData);
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    Inertia.post(route('sms_responders.restore', id), formData);
                    customTableRef.current.fetchData(1);
                }
            });
    }
    ...
    const columns = [
        ...
        },
        {
            ...
            selector: 'status',
            left:true,
            cell: row =>row.status==1 ? <span className="badge badge-success p-2 m-1" style={{fontSize:'14px'}}>Active</span> : <span className="badge badge-danger p-2 m-1" style={{fontSize:'14px'}}>Inactive</span>,
        },
        {
            selector: 'id',
            name: 'Action',
            ...
            cell: row =><div className="btn-group">
                            <Dropdown>
                                <DropdownToggle variant="btn" disabled={editFound ? false : true} className="btn btn-outline-primary">
                                ...
                                {(row.deleted_at == null) &&
                                    ...
                                    <DropdownMenu>
                                        <InertiaLink href={route('sms_responders.edit',row.id)} className={editFound ? "dropdown-item cursor-pointer" : "dropdown-item cursor-pointer disabled"} as="button">
...
export default SmsAutoResponder;
