        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    Inertia.post(route('location_type.destroy', id), formData);
            ...
            cell: row =><div className="btn-group">
                            <Dropdown>
                                ...
                                {(row.deleted_at == null) &&
                                    ...
                                    <DropdownMenu>
                                        {editFound &&
                                            <InertiaLink href={route('location_type.edit',row.id)} className="dropdown-item cursor-pointer" as="button">
