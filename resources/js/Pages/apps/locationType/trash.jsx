...
export default function typeTrashList(props) {
    ...
    const fetchUsers = async (page, size = perPage) => {
        ...
        const response = await axios.get(
            base_url + `/location_type/type_trash?page=${page}&per_page=${size}&delay=1`
        );
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    Inertia.post(route('location_type.restore', id), formData);
                    fetchUsers(1);
                }
            });
    }
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: row => <div className="btn-group">
                <Dropdown>
                    <DropdownToggle variant="btn" className='btn btn-outline-primary'>
                    ...
                    <div className="card text-left">
                        ...
                        <div className="card-body">
                            <div className="table-responsive">
                                ...
                                <div>
                                    <InertiaLink href={route('location_type.trashList')} className="pr-2">
                                        View Trash Records
                                    </InertiaLink>
                                    |
                                    <InertiaLink href={route('location_type.index')} className="pl-2">
                                        View Active Records
                                    </InertiaLink>
                                </div>
