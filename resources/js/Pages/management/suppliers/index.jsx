...
const RecordList = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            left: true,
            cell: row => 
            <InertiaLink href={route('management.suppliers.edit', row.id)} className="" >
                {row.company_name}
            </InertiaLink>
            ...
            cell: row => <div className="btn-group" >
                <Dropdown>
                    ...
                    {(row.deleted_at == null) &&
                        <DropdownMenu>
                            {editFound &&
                                <InertiaLink href={route('management.suppliers.edit', row.id)} className="dropdown-item cursor-pointer" as="button">
                    ...
                    <div className="card text-left">
                                    ...
                                    <div className="col-md-4 text-right">
                                        <div className="btn-group dropleft">
                                            ...
                                            <Dropdown>
                                                ...
                                                <DropdownMenu>
                                                    <InertiaLink className="dropdown-item cursor-pointer" href={route('management.suppliers.create')}>
                                                        Add
                                                    </InertiaLink>
                                                </DropdownMenu>
                                            </Dropdown>
                        ...
                        <div className="card-body">
                            <CustomDataTable
                                ...
                                ref={customTableRef}
                                url='records_data'
                                routeName='management.suppliers'
                            />
