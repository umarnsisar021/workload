    ...
    const columns = [
        ...
        },
        {
            ...
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">Brokers</Col>
                 <Col sm={12} ><input type="text"  className="form-control" {...register("name")} /></Col>
             </Row>
            </div>,
            left: true,
            cell:row=>
            <InertiaLink href={route('management.brokers.edit', row.id)} className="" >
                {row.name}
            </InertiaLink>
            ...
            cell: row => <div className="btn-group" >
                <Dropdown>
                    ...
                    {(row.deleted_at == null) &&
                        <DropdownMenu>
                            {editFound &&
                                <InertiaLink href={route('management.brokers.edit', row.id)} className="dropdown-item cursor-pointer" as="button">
                                    ...
                                    <div className="col-md-4 text-right">
                                        <div className="btn-group dropleft">
                                            ...
                                            <Dropdown>
                                                ...
                                                <DropdownMenu>
                                                    <InertiaLink className="dropdown-item cursor-pointer" href={route('management.brokers.create')}>
                                                        Add
                                                    </InertiaLink>
                                                </DropdownMenu>
                                            </Dropdown>
