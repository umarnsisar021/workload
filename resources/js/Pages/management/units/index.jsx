...
const RecordList = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            left: true,
            cell:row=>
            <InertiaLink href={route('management.units.edit', row.id)} className="" >
                {row.name}
            </InertiaLink>
            ...
            cell: row => <div className="btn-group" >
                <Dropdown>
                    ...
                    {(row.deleted_at == null) &&
                        <DropdownMenu>
                            {editFound &&
                                <InertiaLink href={route('management.units.edit', row.id)} className="dropdown-item cursor-pointer" as="button">
                                    ...
                                    <div className="col-md-4 text-right">
                                        <div className="btn-group dropleft">
                                            <Dropdown>
                                                ...
                                                <DropdownMenu>
                                                    <InertiaLink className="dropdown-item cursor-pointer" href={route('management.units.create')}>
                                                        Add
                                                    </InertiaLink>
                                                </DropdownMenu>
                                            </Dropdown>
