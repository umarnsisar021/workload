...
export default function createCurrency(props) {
    ...
    function handleSubmit(event) {
        ...
        Inertia.post(route('catalogs.brands.store'), values, {
            onSuccess: response => {
                                ...
                                <div className="row">
                                    <div className="col-md-8">
                                        <h4 className="card-title">
                                            <InertiaLink href={route('catalogs.brands.index')}>
                                                <span
                                ...
                                <div className="row">
                                    <div className="col-md-6 ">
                                        ...
                                        <div className="form-group mb-3">
                                            ...
                                            />
                                            {errors.code && <span className="text-danger">{errors.description}</span>}
                                        </div>
