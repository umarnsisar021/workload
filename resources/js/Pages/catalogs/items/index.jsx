...
const RecordList = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            left: true,
            cell:row=>
            <InertiaLink href={route('catalogs.items.edit', row.id)} className="" >
                 {row.name}
            </InertiaLink>

        },
        {
            selector: 'unit_department_name',
            name: 'Department',
            sortable: true,
        },
        {
            selector: 'unit',
            name: <span title="Unit of Measure">UOM</span>,
            sortable: true,
        },
        {
            selector: 'status',
            ...
            cell: row => <div className="btn-group" >
                <Dropdown>
                    ...
                    {(row.deleted_at == null) &&
                        <DropdownMenu>
                            {editFound &&
                                <InertiaLink href={route('catalogs.items.edit', row.id)} className="dropdown-item cursor-pointer" as="button">
                                    ...
                                    <div className="col-md-4 text-right">
                                        <div className="btn-group dropleft">
                                            <Dropdown>
                                                ...
                                                <DropdownMenu>
                                                    <InertiaLink className="dropdown-item cursor-pointer" href={route('catalogs.items.create')}>
                                                        Add
                                                    </InertiaLink>
                                                </DropdownMenu>
                                            </Dropdown>
