...
const RecordList = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">In / Out</Col>
                 <Col sm={12} ><input type="text"  className="form-control" {...register("type")} /></Col>
             </Row>
            </div>,
            left: true,
            cell: row =>
...

        {
            ...
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">Gate Pass #</Col>
                 <Col sm={12} ><input type="text"  className="form-control" {...register("gp_no")} /></Col>
             </Row>
            </div>,
            left: true,
            width:'130px',
            ...
            (row.action=="footer") ?
            '':
            <InertiaLink href={route('others.gate_passes.edit', row.id)} className="" >
                {row.gp_no}
            </InertiaLink>
        ...
        },
        {
            ...
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">Item</Col>
                 <Col sm={12} ><input type="text"  className="form-control" {...register("item")} /></Col>
             </Row>
            </div>,
            width:'200px',
            left: true,
        ...
        },
        {
            ...
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">Qty</Col>
        ...
        },
        {
            ...
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">Qty Unit</Col>
                 <Col sm={12} ><input type="text"  className="form-control" {...register("unit")} /></Col>
             </Row>
            </div>,
            left: true,
        ...
        },
        {
            ...
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">VH #</Col>
        ...
        },
        {
            ...
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">Rolls</Col>
                 <Col sm={12} ><input type="text"  className="form-control" {...register("roll")} /></Col>
             </Row>
            </div>,
            left: true,
            cell: row => 
            ...
            <div className="btn-group" >
                <Dropdown>
                    ...
                    {(row.deleted_at == null) &&
                        <DropdownMenu>
                            {editFound &&
                                <InertiaLink href={route('others.gate_passes.edit', row.id)} className="dropdown-item cursor-pointer" as="button">
                                    ...
                                    <div className="col-md-4 text-right">
                                        <div className="btn-group dropleft">
                                            ...
                                            <Dropdown>
                                                ...
                                                <DropdownMenu>
                                                    <InertiaLink className="dropdown-item cursor-pointer" href={route('others.gate_passes.create')}>
                                                        Add
                                                    </InertiaLink>
                                                </DropdownMenu>
                                            </Dropdown>
