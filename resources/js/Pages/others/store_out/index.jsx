...
const RecordList = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            (row.action=="footer") ?
            '':
            <InertiaLink href={route('others.store_out.edit', row.id)} className="" >
                {row.po_no}
            </InertiaLink>
        ...
        },
        {
            ...
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">Req. Slip #</Col>
                 <Col sm={12} ><input type="text"  className="form-control" {...register("slip_no")} /></Col>
             </Row>
            </div>,
            left: true,
            cell: row => 
        ...
        },
        {
            ...
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">Rate</Col>
        ...
        },
        {
            ...
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">Issue To</Col>
                 <Col sm={12} ><input type="text"  className="form-control" {...register("issue_to")} /></Col>
             </Row>
            </div>,
            left: true,
            cell: row => 
            ...
            <div className="btn-group" >
                <Dropdown>
                    ...
                    {(row.deleted_at == null) &&
                        <DropdownMenu>
                            {editFound &&
                                <InertiaLink href={route('others.store_out.edit', row.id)} className="dropdown-item cursor-pointer" as="button">
                                    ...
                                    <div className="col-md-4 text-right">
                                        ...
                                        <div className="text-center mr-2">
                                            ...
                                            <Dropdown>
                                                ...
                                                <DropdownMenu>
                                                    <InertiaLink className="dropdown-item cursor-pointer" href={route('others.store_out.create')}>
                                                        Add
                                                    </InertiaLink>
                                                </DropdownMenu>
                                            </Dropdown>
