...
export default function editRecord(props) {
    ...
    const [issueUnitDepartmentID, setIssueUnitDepartmentID] = useState(record_data.issue_unit_department_id)
    ...
    function handleSubmit(event) {
        ...
        Inertia.post(route('others.store_out.update', record_data.id), values,
            {
                onSuccess: response => {
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 ">
                                        ...
                                        <div className="form-group mb-3">
                                            ...
                                            <input type="text" defaultValue={record_data.slip_no}
                                    ...
                                    <div className="form-group mb-3">
                                            ...
                                            <Select
                                                ...
                                                isSearchable
                                                options={unit_departments}
                                                value={unit_departments.filter(({ value }) => value === issueUnitDepartmentID)}
                                                styles={{
                                                    control: base => ({
                                                      ...base,
                                                      height: 34,
                                    ...
                                    <div className="form-group mb-3">
                                            ...
                                            <input defaultValue={record_data.issue_to}
                                                className={errors.issue_to ? 'form-control is-invalid' : 'form-control'}
                                                {...register("issue_to")}
                                            />
