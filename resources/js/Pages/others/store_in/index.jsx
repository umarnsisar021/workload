...
const RecordList = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            (row.action=="footer") ?
            '':
            <InertiaLink href={route('others.store_in.edit', row.id)} className="" >
                {row.po_no}
            </InertiaLink>
        ...
        },
        {
            ...
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">Received From</Col>
                 <Col sm={12} ><input type="text"  className="form-control" {...register("received_from")} /></Col>
             </Row>
            </div>,
            width:'150px',
            left: true,
            ...
            <div className="btn-group" >
                <Dropdown>
                    ...
                    {(row.deleted_at == null) &&
                        <DropdownMenu>
                            {editFound &&
                                <InertiaLink href={route('others.store_in.edit', row.id)} className="dropdown-item cursor-pointer" as="button">
                                    ...
                                    <div className="col-md-4 text-right">
                                        <div className="btn-group dropleft">
                                            ...
                                            <Dropdown>
                                                ...
                                                <DropdownMenu>
                                                    <InertiaLink className="dropdown-item cursor-pointer" href={route('others.store_in.create')}>
                                                        Add
                                                    </InertiaLink>
                                                </DropdownMenu>
                                            </Dropdown>
