...
export default function createRecord(props) {
    ...
    function handleSubmit(event) {
        ...
        Inertia.post(route('others.store_in.store'), values, {
            onSuccess: response => {
                                        ...
                                        <div className="form-group mb-3">
                                            ...
                                            <div className="">
                                                <label className="radio radio-outline-success ">
                                                    <input type="radio" name="billed"  value="1" defaultChecked {...register("billed")} /><span>No</span><span className="checkmark"></span>
                                                </label>
                                                <label className="radio radio-outline-success ">
                                                    <input type="radio" name="billed"  value="2"  {...register("billed")} /><span>Yes</span><span className="checkmark"></span>
                                                </label>
                                            </div> 
