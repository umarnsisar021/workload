...
const RecordList = (props) => {
    ...
    const columns = [
...

        {
            ...
            (row.action=="footer") ?
            '':
            <InertiaLink href={route('doubling.outwards.edit', row.id)} className="" >
                {row.chalan_no}
            </InertiaLink>
        },
        {
            selector: 'delivery_unit_name',
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">Delivered To</Col>
                 <Col sm={12} ><input type="text"  className="form-control" {...register("deliver_unit_name")} /></Col>
             </Row>
            </div>,
            width: '140px',
            ...
            <div className="btn-group">
                {row.delivery_unit_name}
                {row.delivery_customer_name}
            </div>
        },
            ...
            <div className="btn-group" >
                <Dropdown>
                    ...
                    {(row.deleted_at == null) &&
                        <DropdownMenu>
                            {editFound &&
                                <InertiaLink href={route('doubling.outwards.edit', row.id)} className="dropdown-item cursor-pointer" as="button">
                                    ...
                                    <div className="col-md-4 text-right">
                                        <div className="btn-group dropleft">
                                            ...
                                            <Dropdown>
                                                ...
                                                <DropdownMenu>
                                                    <InertiaLink className="dropdown-item cursor-pointer" href={route('doubling.outwards.create')}>
                                                        Add
                                                    </InertiaLink>
                                                </DropdownMenu>
                                            </Dropdown>
