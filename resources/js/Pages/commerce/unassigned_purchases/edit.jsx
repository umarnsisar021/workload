...
export default function editRecord(props) {
    ...
    function handleSubmit(event) {
        ...
        Inertia.post(route('commerce.unassigned_purchases.update', record_data.id), values,
            {
                onSuccess: response => {
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 ">
                                        <div className="form-group mb-3">
                                            <label>Date</label>
                                            <input type="date" defaultValue={record_data.invoice_date}
                                    ...
                                    <div className="col-md-6 ">
                                        <div className="form-group mb-3">
                                            <label>Qty (Lbs)</label>
                                            <input type="number" defaultValue={record_data.qty} name="key['name']"
                                    ...
                                    <div className="col-md-6 ">
                                        <div className="form-group mb-3">
                                            ...
                                            <input type="number" defaultValue={record_data.rate}
