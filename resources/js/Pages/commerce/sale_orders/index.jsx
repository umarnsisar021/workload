    ...
    const columns = [
        {
            ...
            center: true,
            cell: row => 
            <InertiaLink href={route('commerce.sale_orders.edit', row.id)} className="" >
        ...
        },
        {
            ...
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">A/G #</Col>
        ...
        },
        {
            ...
            name: <div>
            <Row className="form-group ">
             <Col sm={12} className="mt-2 mb-2 text-center">Customer</Col>
            ...
            cell: row => <div className="btn-group" >
                <Dropdown>
                    ...
                    {(row.deleted_at == null) &&
                        <DropdownMenu>
                            {editFound &&
                                <InertiaLink href={route('commerce.sale_orders.edit', row.id)} className="dropdown-item cursor-pointer" as="button">
                    ...
                    <div className="card text-left">
                                    ...
                                    <div className="col-md-4 text-right">
                                        <div className="btn-group dropleft">
                                            ...
                                            <Dropdown>
                                                ...
                                                <DropdownMenu>
                                                    <InertiaLink className="dropdown-item cursor-pointer" href={route('commerce.sale_orders.create')}>
                                                        Add
                                                    </InertiaLink>
                                                </DropdownMenu>
                                            </Dropdown>
                        ...
                        <div className="card-body">
                            <CustomDataTable
                                ...
                                ref={customTableRef}
                                url='records_data'
                                routeName='commerce.sale_orders'
                            />
